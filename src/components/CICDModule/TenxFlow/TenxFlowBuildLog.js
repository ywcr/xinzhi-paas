      ...
      return (
        <Panel header={header} className={'LogDetail LogDetail' + index} key={'LogDetail' + index} >
          ...
          <div className='rightInfo'>
            <TenxFlowStageBuildLog scope={scope} logs={item.logInfo} isFetching={item.isFetching} logInfo={item} flowId={flowId} callback={this.props.callback} index={index} visible={this.props.visible}/>
          </div>
        </Panel>
      );
    });
